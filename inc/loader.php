...
function add_styles() {
    ...
    wp_enqueue_style('bootstrap', '//stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css', '4.1');
    wp_enqueue_style('fontawesome', '//use.fontawesome.com/releases/v5.4.2/css/all.css');    
